...
const CreateAccountDrawer = ({ children }: { children: React.ReactNode }) => {
    ...
    const onSubmit = async (data: { name: string; type: "CURRENT" | "SAVINGS"; balance: string; isDefault: boolean }) => {
                ...
                <div className="px-4 py-4">
                    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            <Button type="submit" className="flex-1" disabled={createAccountLoading ?? false}>
